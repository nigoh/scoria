    ...
    >
      ...
      <g transform="translate(195, 80)">
        ...
        <circle r="5" fill={c.accent} opacity="0.15">
          <animateMotion
            ...
            path="M10,100 C30,80 50,60 70,50 C90,40 110,45 130,40"
          />
          <animate
      ...
      <g transform="translate(370, 40)">
        ...
        <rect
          ...
          strokeWidth="1"
        />
        <text x="26" y="180" textAnchor="middle" fontSize="7" fill={c.g3} fontFamily="monospace">
          .md
        </text>
        <rect
          x="44"
          ...
          strokeWidth="1"
        />
        <text x="56" y="180" textAnchor="middle" fontSize="7" fill={c.g3} fontFamily="monospace">
          .pdf
        </text>
      </g>
