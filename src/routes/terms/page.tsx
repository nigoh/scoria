    ...
    <PageContainer className="max-w-3xl">
      ...
      <div className="mt-8 space-y-8 text-sm leading-relaxed text-foreground">
        <section>
          ...
          <p className="mt-2">
            Scoria（以下「本サービス」）は、研究ソフトウェア開発に関する Claude Code
            拡張を自動生成するウェブアプリケーションです。本サービスを利用することで、以下の利用規約に同意したものとみなします。
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="mt-2 list-inside list-disc space-y-1 text-muted-foreground">
            ...
            <li>
              LLM API
              を通じて得られる応答の正確性・信頼性について、本サービスは一切の責任を負いません
            </li>
        ...
        <section>
          ...
          <p className="mt-2">
            ユーザーが本サービスに設定する LLM API キーの管理はユーザー自身の責任です。API
            キーの漏洩、不正利用、およびそれに伴う費用について、本サービスは責任を負いません。
          </p>
        </section>

        <section>
          <h2 className="text-lg font-semibold">4. 禁止事項</h2>
          <p className="mt-2">本サービスの利用にあたり、以下の行為を禁止します。</p>
          <ul className="mt-2 list-inside list-disc space-y-1 text-muted-foreground">
            <li>本サービスの不正利用や妨害行為</li>
            <li>本サービスを利用した違法行為、または公序良俗に反する行為</li>
            <li>本サービスのリバースエンジニアリング（オープンソースの範囲を除く）</li>
        ...
        <section>
          <h2 className="text-lg font-semibold">6. サービスの変更・停止・終了</h2>
          <p className="mt-2">
